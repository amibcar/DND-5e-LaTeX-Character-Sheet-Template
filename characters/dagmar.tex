...
\SecondLevelSpellSlotC{Web (Wand of Web)}
\SecondLevelSpellSlotD{Detect Thoughts (Circlet of Telepathy)}
\SecondLevelSpellSlotE{Suggestion (Circlet of Telepathy)}

\ThirdLevelSpellSlotsTotal{3}
\ThirdLevelSpellSlotA{Lighting Bolt (V, S, M)}

\FourthLevelSpellSlotsTotal{3}
\FourthLevelSpellSlotA{Dominate Beast (V, S)}
\FourthLevelSpellSlotB{Greater Invisibility (V, S)}
\FourthLevelSpellSlotC{Ice Storm (V, S, M)}

\FifthLevelSpellSlotsTotal{2}
\FifthLevelSpellSlotA{Cone of Cold (V, S, M)}
\FifthLevelSpellSlotB{Telekinesis (V, S)}
...
\SeventhLevelSpellSlotA{Teleport (V)}
\SeventhLevelSpellSlotB{Crown of Ice (V, S)}
...
\begin{DndTable}[]{lcccc}
\textbf{Familiarity}        &     \textbf{Mishap}     &   \multicolumn{1}{|p{3cm}|}{\centering \textbf{Similar \\ Area}}  &    \multicolumn{1}{|p{3cm}|}{\centering \textbf{Off \\ Target}}   &     \multicolumn{1}{|p{3cm}|}{\centering \textbf{On \\ Target}}    \\
